  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        {!fullScreenMode && (
          <motion.div
            className="relative w-[95%] sm:w-[90%] max-w-xs sm:max-w-4xl md:max-w-6xl mx-auto overflow-hidden rounded-lg bg-gray-900/80 backdrop-blur-lg h-[85vh] sm:h-[90vh] flex flex-col"
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row flex-1 overflow-hidden">
              ...
              <div 
                className="relative w-full lg:w-3/5 overflow-hidden bg-black aspect-video max-h-[45vh] sm:max-h-[55vh] lg:max-h-none lg:h-full"
                {...handlers}
              >
                <AnimatePresence mode="wait">
                  <motion.div
              ...
              <div className="p-5 sm:p-6 lg:w-2/5 lg:py-8 lg:px-8 lg:flex lg:flex-col lg:justify-between overflow-y-auto">
                {/* Project title */}
                <div>
                  <h2 
                    id="popup-title" 
                    className="text-3xl sm:text-4xl font-bold text-white mb-4 text-center lg:text-left lg:mb-6"
                  >
                    {project.project_name}
                  </h2>

                  {/* Project description */}
                  <p className="text-gray-300 mb-6 text-base sm:text-lg lg:leading-relaxed">
                    {project.full_desc}
                  </p>
                  ...
                  <div className="mb-8 flex flex-wrap gap-2">
                    {project.tags.map((tag, index) => (
                      <span
                        key={index}
                        className="px-3 py-1.5 rounded-full text-sm sm:text-base font-medium text-white shadow-sm shadow-black/10"
                ...
                <div className="mt-auto flex justify-center">
                  <motion.a
                    ...
                    className="w-full sm:w-[80%] group inline-flex items-center justify-center gap-2 px-5 py-3 border border-white/20 bg-white/5 hover:bg-white/10 backdrop-blur-sm text-white rounded-lg transition-all shadow-sm overflow-hidden text-base"
                ...
                <div className="mt-6 text-center lg:text-left text-sm sm:text-base text-gray-400">
            ...
            <div className="hidden lg:flex gap-2 p-4 bg-black/40">
              {project.photos.map((photo, index) => (
                <button
                  ...
                  className={`relative h-20 w-20 rounded overflow-hidden flex-shrink-0 transition-all
