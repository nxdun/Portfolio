  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="-mt-18 absolute right-0 h-32 w-8 translate-x-12 rotate-12 bg-white opacity-10 transition-all duration-1000 ease-out group-hover:-translate-x-40" />
          <div className="flex items-center">
            <svg className="h-4 w-4 fill-current" viewBox="0 0 438.549 4</svg>38.549">
          ...
          <div className="ml-2 flex items-center gap-1 text-sm md:flex">
            ...
            <span className="font-display inline-block font-medium tabular-nums tracking-wider text-white"></span>
          </div>
        </button>
      </motion.div>
    </motion.div>
