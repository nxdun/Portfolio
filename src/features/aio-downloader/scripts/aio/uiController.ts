import type { ToolResponseState } from "@/scripts/tools/ui/responseDock";
import type { AioDomRefs } from "./dom";

export type AioUiState =
  | "IDLE"
  | "AWAITING_CAPTCHA"
  | "LOADING_CAPTCHA"
  | "SUBMITTING"
...
export class AioUiController {
  private state: AioUiState = "IDLE";
